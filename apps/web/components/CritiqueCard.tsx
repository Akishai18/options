  ...
  return (
    ...
    >
      ...
      <div className="rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
        <p className="text-[14px] leading-[1.7] text-[var(--color-fg)]">
        ...
        <div className="mt-4 flex items-center gap-2 border-t border-[var(--color-border)] pt-3">
          <span className="h-1 w-1 rounded-full bg-[var(--color-up)]" />
          <span className="eyebrow text-[10px]">grounded in computed metrics — no market reasoning</span>
        </div>
      </div>
    </motion.div>
  );
